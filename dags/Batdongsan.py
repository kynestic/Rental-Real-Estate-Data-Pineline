...
from src.extract import Batdongsan
from scripts.batdongsan import processed, parsed, served
...
def run_publisher_task(**kwargs):
    ...
    try:
        ...
        publish_urls(Batdongsan, channel, SITE_NAME)
    finally:
        connection.close()
